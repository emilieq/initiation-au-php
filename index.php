...
<html lang="en">
  ...
  <title>
    ...
    <link rel="stylesheet" type="text/css" href="templette.css">
  ...
  <body>
    ...
    <nav  id="menu"class="navbar navbar-expand-md navbar-dark fixed-top">
            <a class="navbar-brand" href="#">PHP Table</a>
          ...
          <main >
              ...
              <div >
                    <h1 class="main title">Table de multiplication</h1>
                    <img id="cover"src="cover.jpg" alt="image de multiplication">
